...
public class AgentPasswordPanelUI {
	...
	_loginNameLabel = new JLabel("Enter login name");
	...
	_loginField.setMaximumSize(new Dimension(270, 26));
    }
	...
	_loginPanel.setPreferredSize(new Dimension(150, 250));
    }

    private void combineComponents() {

	_loginPanel.add(Box.createVerticalStrut(100));
	_loginPanel.add(_loginNameLabel);
